...
class DataProcessor:
    def __init__(self):
        ...
        self.origin_data["dgs_jpy_diff"] = (self.origin_data["dgs10"] - self.origin_data["jpy10"])
        self.origin_data["dgs_eur_diff"] = (self.origin_data["dgs10"] - self.origin_data["eur10"])
